                ...
                <>
                    <section className="flex flex-col items-center gap-10 mb-10">
                        ...
                        <p className="max-w-3xl m-auto">
                            ...
                            <br />
                            Chaque équipe doit avoir sa propre stratégie pour les réaliser. Certaines se réalisent ne avançant dans le jeu
                            de manière "standard", d'autres nécessitent réflexion, stratégie et optmisation.
                        </p>
                    ...
                    <ChallengeProgrammation eventId={event.id} />
                </>
            )}
        </main>
    );
