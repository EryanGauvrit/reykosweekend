...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(
    ({ className, variant = 'success', size = 'icon', ...props }, ref) => {
        ...
        return (
            <Button
                ...
                size={size}
                className={cn(
                    'absolute  h-12 w-12 rounded-full bg-accent text-accent-foreground hover:bg-success opacity-85',
                    orientation === 'horizontal'
                        ? '-left-8 lg:-left-14 top-1/3 -translate-y-1/2'
        ...
        return (
            <Button
                ...
                className={cn(
                    'absolute h-12 w-12 rounded-full bg-accent text-accent-foreground hover:bg-success opacity-85',
                    orientation === 'horizontal'
                        ? '-right-8 lg:-right-14 top-1/3 -translate-y-1/2'
